...
#include <strix/client/match/node/model/MatchServerNodeRoom.h>
...
/**
 *  An implementation of MatchServerNodeRoom with customizable keys and properties
 */
class CustomizableMatchServerNodeRoom : public MatchServerNodeRoom
{
public:
	STRIX_CLASS(CustomizableMatchServerNodeRoom, MatchServerNodeRoom)
	(
		STRIX_CLASS_ID("jp.co.soft_gear.strix.server.match.node.model.CustomizableMatchServerNodeRoom")
	...
	CustomizableMatchServerNodeRoom() {}

	virtual ~CustomizableMatchServerNodeRoom() {}
...
typedef std::shared_ptr<CustomizableMatchServerNodeRoom> CustomizableMatchServerNodeRoomPtr;

...
/**
 *  Performs serialization and deserialization of objects for direct relay messages
 */
class RoomDirectRelayMessageSerializer : public strix::net::serialization::serializer::GenericObjectSerializer
{
public:
